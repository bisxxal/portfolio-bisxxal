  ...
  return (
    <div>
        <div ref={ref} className="skils  relative min-h-[110vh] w-full capitalize overflow-hidden max-lg:pb-10 bg-[#000319  text-[white]">
          ...
          {/* <FlickeringGrid
          className="z-0 absolute inset-0 !w-full !h-full  size-full"
          squareSize={4}
          gridGap={6}
          color="#6B7280"
          maxOpacity={0.5}
...
<Particles  
      ...
      />
          ...
          <div className="skillwrapper defect1 h-[99%] w-full flex lg:items-center  justify-center ">
            ...
            <div drag dragConstraints={ref} whileDrag={{scale:1.01}} className="skilsimgh frame inshadow shadow-2xl shadow-[black] w-[150px]  h-[145px] flex-col flex items-center justify-center overflow-hidden rounded-2xl lg:mx-[50px] bg-[#ffffff09]  backdrop-blur-[5px] ">
            ...
            <div drag dragConstraints={ref} whileDrag={{scale:1.01}} className="skilsimgh frame inshadow shadow-xl shadow-[black] w-[150px] h-[145px] flex-col flex items-center justify-center overflow-hidden rounded-2xl lg:mx-[50px] bg-[#ffffff09]  backdrop-blur-[5px]  defect1">
            ...
            <div drag dragConstraints={ref} whileDrag={{scale:1.01}} className="skilsimgh frame inshadow shadow-xl shadow-[black] w-[150px] h-[145px] flex-col flex items-center justify-center overflow-hidden rounded-2xl lg:mx-[50px] bg-[#ffffff09]  backdrop-blur-[5px]   react  ">
            ...
            <div drag dragConstraints={ref} whileDrag={{scale:1.01}} className="skilsimgh frame inshadow shadow-xl shadow-[black] w-[150px] h-[145px] flex-col flex items-center justify-center overflow-hidden rounded-2xl lg:mx-[50px] bg-[#ffffff09]  backdrop-blur-[5px]  defect1 mrg ps">
            ...
            <div drag dragConstraints={ref} whileDrag={{scale:1.01}} className="skilsimgh frame inshadow shadow-xl shadow-[black] w-[150px] h-[145px] flex-col flex items-center justify-center overflow-hidden rounded-2xl lg:mx-[50px] bg-[#ffffff09]  backdrop-blur-[5px]  mrg ht">
