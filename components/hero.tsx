  ...
  return (
   ...
   <DotPattern
      ...
      >
        ...
        <div className="gd absolute max-lg:left-[20%] left-[45%] bg-[#2d53bc28] h-60  max-lg:h-52 max-lg:w-[200px] w-[350px] rounded-full blur-[100px] max-lg:blur-[70px]"></div>
        ...
        <div className="gd absolute max-lg:left-[35%] left-[33%] bg-[#ff04c928] h-60 max-lg:h-52  max-lg:w-[200px] w-[350px] rounded-full blur-[100px]  "></div>
        ...
        <div 
          className=" d-pointer relative flex items-center w-full h-[90%] bg-zinc-5 justify-center  "
