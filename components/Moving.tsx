...
function Moveing() {
  ...
  return (
    <div ref={container} className="movindtextdiv text-[#ffffffae] max-md:my-7 mt-10 leading-none lg:text-[200px] text-[100px] lg:h-[250px] overflow-hidden mb-[7vh] relative whitespace-nowrap z-[20] w-full ">
