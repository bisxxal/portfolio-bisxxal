...
function Loader() {
  ...
  return (
    <div className='load  bg-[#080312] w-full flex items-center justify-center flex-col text-white h-screen fixed top-0 left-0 z-[100]  opacity-1'>
      ...
      <div className="absolute rounded-full globe globe2 -top-[100px] max-md:-top-[50px] max-md:-left-[360px] -left-[500px] max-md:w-[600px] max-md:h-[600px] h-[1300px] w-[1300px]  border-[8px]  blur-[18px] heroshadow2 "></div>
