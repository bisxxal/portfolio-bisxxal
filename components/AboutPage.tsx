...
function AboutPage() {
  ...
  return (
    <div className="abtpg relative bg-red-00  max-lg:h-screen max-md:overflow-hidden min-h-[110vh] mt-12 max-md:mt-20 flex flex-col justify-evenly "  >
      ...
      <h1 className="me max-md:text-2xl text-8xl font-extrabold text-center max-md:pt-10 logo"> About Me</h1>
      <div className="dev text-[#ffffffc7] max-lg:text-3xl max-md:text-xl ax-md:-mt-14 -mt-20 text-center text-[40px] leading-[45px] text-4x w-[85%] h-full flex flex-col items-center justify-center mx-auto font-bold">
