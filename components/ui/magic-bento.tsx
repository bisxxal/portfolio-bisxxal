...
const DEFAULT_GLOW_COLOR = "#ff7300";
...
const cardData: BentoCardProps[] = [
    {
        color: "#060010",
        title: "Analytics",
        description: "Track seo behavior",
        label: "Insights",
        background: img.w5,
    },
    {
...
const BentoCardGrid: React.FC<{
    ...
    <div
        className="bento-section grid gap-2 p-3 max-md:p-1  w-full select-none relative"
                        ...
                        if (enableStars) {
                            return (
                                ...
                                >
                                    ...
                                    {/* <img className=" w-full h-full border " src='/w8.png' alt="" /> */}
                                    <Image className=" w-full h-full object-cover   " src={card.background} alt="" />
